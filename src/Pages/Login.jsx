              ...
              <form className="mx-auto flex justify-center items-center">
                <div class="relative">
                  <div class="absolute start-0 flex items-center pointer-events-none"></div>
                    <input type="login" id="login" class="block w-full py-2.5 px-14 pxtext-sm text-white border border-gray-300 rounded-lg bg-[#0a0a0a] focus:ring-blue-500 focus:border-white " placeholder="Masukan Email atau Username" />
                </div>
              </form>
            </div>
          </div>
